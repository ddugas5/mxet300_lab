...
# the list elements within each list are in order as follows: cwhassis forward velocity (m/s), chassis angular velocity (rad/s), and motion duration (sec)
...
motions = [
    ...
    [0.4, 0.0, 2],            # Motion 3
    [0.0, pi/2, 1.2],            # Motion 4
    [0.4, 0.0, 2],            # Motion 5
    [0.0, -pi/2, 1.2],           # Motion 6
    [0.4, 0.0, 2],            # Motion 7
    [0.0, -pi/2, 1.2],            # Motion 8
    [0.4, 0.0, 2],            # Motion 9
