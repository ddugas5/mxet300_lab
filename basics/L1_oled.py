...
def getVoltage():
    ...
    ##########################################
    return volts
# Be sure to return your variable name for your getVoltage()
...
def displayText():
    ...
    #################################################
    draw.text((40, 0), "Optimus Prime", font=font, fill=255)
    draw.text((0, 30), "Voltage: " + volts + "V", font=font, fill=255)
